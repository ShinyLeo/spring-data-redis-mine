package com.shinyleo.spring.redis;

import com.shinyleo.spring.SerializeUtil;
...
public class RedisClient implements InitializingBean{
    ...
    public Object setObject(String key,Object obj){
        ...
        try {
            ...
            redisService.returnResource(shardedJedis, broken);
        }
        return result;
    }
    ...
    public Object getObject(String key){
        ...
        try {
            ...
            if(resultByte.length >0){
                result = SerializeUtil.unserialize(resultByte);
            }else{
                return null;
            }
        } catch (Exception e) {
